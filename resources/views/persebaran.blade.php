...
@section('content')
<link rel="stylesheet" href="{{asset('assets/plugins/pace_master/themes/blue/pace-theme-flash.css')}}">
...
@media only screen and (max-width: 600px) {
    ...
    font-size:30px;
            ...
            choose_daerah = function(value){
                ...
                $.ajax({
                    type: 'POST',
                    url :"http://207.148.68.185/api/v1/school-gsm/list/"+sekolah, 
                    headers: {
            ...
            choose_sekolah = function(value){
                ...
                $.ajax({
                    type: 'GET',
                    url :"http://207.148.68.185/api/v1/school-gsm/"+value
                    }).done(function(data, status){
