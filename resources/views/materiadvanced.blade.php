...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
            ...
            <script>
                ...
                function pilih_kategori(){
                    ...
                    $.ajax({
                            type: 'GET',
                            url :"http://207.148.68.185/api/v1/modul/aspect-grade/"+document.getElementById('pilih_kategori_materi').value+"/advanced"
                            }).done(function(data, status){
                                            ...
                                            '<div class="table-box">'+
                                                '<div class="table-detail">'+
                                                    '<div class="col-md-12">'+
                                                        ...
                                                        '</div>'+
                                                    '</div>'+                                                        '<p style="color:#5d9cec">Category : '+category_materi+'</p>'+
                    ...
                    localStorage.setItem("token", token_user)
                        ...
                        $.ajax({
                            type: 'GET',
                            url :"http://207.148.68.185/api/v1/modul/aspect-grade/ekosistem-positif/advanced"
                            }).done(function(data, status){
                                console.log(data)
                                console.log(status)
                                var jumlah_materi = data.length
